...
@dataclass
class HeliosLegRoughTrainerCfg(TrainerCfg):
...
@dataclass
class HeliosLegFlatTrainerCfg(HeliosLegRoughTrainerCfg):
    max_iterations = 5000
    experiment_name = "helios_leg_flat"
