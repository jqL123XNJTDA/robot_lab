...
class HeliosLegJumpRewardsCfg(HeliosLegRewardsCfg):
    ...
    jump_flight_foot_height = RewTerm(
        ...
        params={
            "command_name": "jump_command",
            "target_height_below": 0.2,  # 脚应在 base 下方的目标距离 [m]
            "asset_cfg": SceneEntityCfg("robot"),
