...
# Thunder_Hist observation configuration (16 joints)
THUNDER_HIST_POLICY_DIMS = [3, 3, 3, 16, 16, 16]  # [ang_vel, gravity, cmd, jpos, jvel, act]
THUNDER_HIST_HISTORY_LEN = 5

# Helios Leg observation configuration (6 joints)
HELIOS_LEG_POLICY_DIMS = [3, 3, 3, 6, 6, 6]  # [ang_vel, gravity, cmd, jpos, jvel, act]
HELIOS_LEG_HISTORY_LEN = 5
